    ...
    <div className="flex justify-between gap-2" role="group" aria-label="Verification code">
      {digits.map((digit, index) => (
        <Input
          ...
          maxLength={1}
          disabled={disabled}
          className={cn("border-border bg-background/80 focus-visible:border-primary/60 focus-visible:ring-primary/30 h-12 w-full text-center text-lg font-semibold shadow-xs dark:bg-input/50", props["aria-invalid"] && "border-destructive")}
          value={digit}

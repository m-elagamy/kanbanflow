...
const FloatingParticles = () => {
  ...
  const glowProps = {
    className: "absolute inset-0 rounded-full bg-gradient-to-t blur-md",
  ...
  return (
    <>
      <motion.div
        className="absolute left-0 size-7 rounded-full bg-gradient-to-t from-[#51FFC0]/30 via-[#5AD8BC]/30 to-[#74A9BD] shadow-lg dark:from-[#004483]/10 dark:via-[#056F6E]/10 dark:to-[#045943]/10"
      ...
      <motion.div
        className="absolute -bottom-2 -right-2 size-7 rounded-full bg-gradient-to-t from-[#EEBF2E]/30 via-[#EEA336]/30 to-[#EF7266] shadow-lg dark:from-[#6A0000]/10 dark:via-[#AA2A07]/10 dark:to-[#9A6B12]/10"
